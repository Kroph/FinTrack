    ...
    try {
        ...
        transactionList.innerHTML = `
            <div class="empty-state" style="padding: 2rem; text-align: center; color: var(--danger);">
                ...
                <button onclick="loadTransactions()" class="filter-toggle" style="margin-top: 1rem;">
    ...
    if (sortedTransactions.length === 0) {
        list.innerHTML = `
            <div class="empty-state" style="padding: 2rem; text-align: center; color: var(--text-light);">
                ...
                <p style="font-size: 0.9rem; margin-top: 0.5rem;">Try adjusting your filters or add a new transaction</p>
            </div>
        `;
        return;
    }
